    ...
    <main className="min-h-screen">
      ...
      <Section className="bg-gray-50 pt-32">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <H1 className="text-4xl md:text-5xl font-bold mb-8">Unifi.id & FireGuard: A New Era in Fire Safety</H1>
      ...
      <Section>
        <div className="max-w-3xl mx-auto px-6">
          <PlaceholderImage className="aspect-video rounded-2xl mb-12 shadow-lg" label="Unifi.id & FireGuard Integration" />
