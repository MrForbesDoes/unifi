    ...
    <main className="min-h-screen">
      ...
      <Section className="bg-gray-50 pt-32">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <H1 className="text-4xl md:text-5xl font-bold mb-8">Case Study: How a University Saved 30% on Energy Costs</H1>
      ...
      <Section>
        <div className="max-w-3xl mx-auto px-6">
          <PlaceholderImage className="aspect-video rounded-2xl mb-12 shadow-lg" label="University Case Study" />
          ...
          <div className="border-t border-gray-200 pt-12 mt-12">
            <div className="bg-unifi-dark rounded-2xl p-8 text-white text-center">
              ...
              <ButtonLink href="/sectors/education" variant="primary">Explore Education Solutions</ButtonLink>
            </div>
          </div>
        </div>
      </Section>
